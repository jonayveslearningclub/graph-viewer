...
function draw() {
  ...
  fill(0);
  textSize(16);
  text("3. Plot point J at (-6, 8) and point K at (4, -5). What is the distance between points J and K?", 20, 30);
  ...
  // Students need to plot and find distance between J(-6, 8) and K(4, -5)
